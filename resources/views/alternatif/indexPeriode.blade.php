...
<div class="card card-primary card-outline">
	<div class="card-header">
		<form class="form-inline">
			...
			<!-- <div class="form-group mr-1" {{ is_hidden('data_mahasiswa.create') }}>
		...
		<table class="table table-bordered table-hover">
			...
			<tr>
				...
				<td><center>
					...
					<a class="btn btn-xs btn-info" href="{{ route('data_mahasiswa.edit', $row->nim) }}" data-toggle="modal" data-target="#modal-edit-{{ $row->nim }}" {{ is_hidden('data_mahasiswa.edit') }}><i class="fa fa-edit"></i> Ubah</a>
					<form action="{{ route('data_mahasiswa.destroy', $row->nim) }}" method="POST" style="display: inline-block;" onsubmit="return confirm('Hapus Data?')" {{ is_hidden('data_mahasiswa.destroy') }}>
						{{ csrf_field() }}
						{{ method_field('DELETE') }}
					...
					<div class="modal-dialog modal-l" role="document">
						<div class="modal-content">
							...
							<div class="modal-body">
								<!-- form start -->
								<form action="{{ route('data_mahasiswa.update', $row->nim) }}" method="post">
									<div class="card">
										<div class="card-body">
											<div class="row">
												<div class="col-md-12">
													...
													<div class="form-group">
														...
														<input autocomplete="off" class="form-control" type="text" name="nama_data" value="{{ old('nama_alternatif', $row->nama_mahasiswa) }}">
													</div>
													<div class="form-group">
										...
										<div class="card-footer">
											...
											<a class="btn btn-danger" href="{{URL('data_mahasiswa')}}"><i class="fa fa-backward"></i> Kembali</a>
										</div>
									</div>
								</form>
							</div>
